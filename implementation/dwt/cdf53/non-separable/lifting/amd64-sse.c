...
TRANSFORM_STEP_FUNC NO_TREE_VECTORIZE cdf53_non_separable_lifting_amd64_sse(size_t step)
{
    switch(step){
        case 0:
...
void NO_TREE_VECTORIZE cdf53_non_separable_lifting_amd64_sse_transform_tile(const TransformStepArguments * tsa)
{
